...
class PlayerDtoMappingTest {
    ...
    @Test
    fun shouldMapAllFieldsCorrectlyInToDomain() {
        ...
        val result: Player = playerDto.toDomain()
    ...
    @Test
    fun shouldMapAllFieldsCorrectlyInToDetailDomain() {
        val playerDto = PlayerDto(
            id = 42,
            firstName = "LeBron",
            lastName = "James",
        ...
        val result: PlayerDetail = playerDto.toDetailDomain()
    ...
    @Test
    fun shouldHandleNullFieldsInToDetailDomain() {
        val playerDto = PlayerDto(
            id = 99,
            firstName = "Test",
            lastName = "Player",
    ...
    @Test
    fun shouldHandleNullFieldsInToDomain() {
        val playerDto = PlayerDto(
            id = 99,
            firstName = "Test",
            lastName = "Player",
